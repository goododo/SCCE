...
if(!dir.exists('C:\\Users\\10784\\Desktop\\SCCE\\4.2.tumor_func')){
  dir.create('C:\\Users\\10784\\Desktop\\SCCE\\4.2.tumor_func',recursive = T)}

setwd('C:\\Users\\10784\\Desktop\\SCCE\\4.2.tumor_func')
# library packages ====
library(dplyr)
library(Seurat)
library(patchwork)
